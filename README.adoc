...
[source,groovy]
----
include::src/test/resources/custom-icon.groovy[]
----
...
[source,groovy]
----
include::src/test/resources/build-status.groovy[]
----
...
[source,groovy]
----
include::src/test/resources/emoji-icon.groovy[]
----
...
[source,groovy]
----
include::src/test/resources/ionicon-icon.groovy[]
----
