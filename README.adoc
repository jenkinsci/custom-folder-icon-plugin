...
image:https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Fcustom-folder-icon-plugin%2Fmain[link="https://ci.jenkins.io/job/Plugins/job/custom-folder-icon-plugin/job/main/"]
...
* Version 2.20 introduces a new type of icon.
The `UrlFolderIcon` allows to use a remote URL as icons.
...
Select the _Build Status Folder Icon_ option to use the combined build status of the jobs within a folder as an icon.
...
Use a remote URL as a source for an icon.

image:docs/url-folder-icon.png[]

Select the _URL Folder Icon_ option and input the URL to be used as an icon source.

image:docs/url-folder-icon-configuration.png[]
